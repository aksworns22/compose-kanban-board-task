...
fun App() {
    FlowRow(
        ...
        TaskCardView(
            ...
            description = Description.Content.of("세로 스크롤 가능한 리스트 컴포넌트를 만들고 성능 최적화를 적용합니다."),
        ...
        TaskCardView(
            ...
            description = Description.Content.of("너무너무너무 긴 설명은 두 줄까지만 노출하고 말줄임표로 처리합니다 두 줄까지만 노출하고 말줄임표로 처리합니다"),
